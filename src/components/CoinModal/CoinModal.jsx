            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content p-4">
                    ...
                    <div className="modal-body">
                        <div className='row border-bottom border-3 border-warning py-3'>
                            <div className='col fs-5'>
                                {coin.image ? <img className='mb-1' src={coin.image.small} alt="logo" width='22' height='22' /> : null}     
                        ...
                        <div className='row border-bottom border-3 border-warning py-3 text-size'>
                            <div className='col-12'>
                                <table className='w-100 text-center'>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_1h_in_currency ? <p>{coin.market_data.price_change_percentage_1h_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_24h_in_currency ? <p>{coin.market_data.price_change_percentage_24h_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_24h_in_currency ? <p>{coin.market_data.price_change_percentage_7d_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_24h_in_currency ? <p>{coin.market_data.price_change_percentage_14d_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_24h_in_currency ? <p>{coin.market_data.price_change_percentage_30d_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                            <td className='border pt-3 border-2'>{coin.market_data?.price_change_percentage_24h_in_currency ? <p>{coin.market_data.price_change_percentage_1y_in_currency.usd.toFixed(1)}%</p> : null}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div className='row border-bottom border-3 border-warning py-3 text-size'>
                            <div className='col-12'>
                                ...
                                <div className='d-flex justify-content-between border-bottom border-1'>
                                    ...
                                    {coin.market_data ? <span>{coin.market_data.circulating_supply}</span> : null}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="modal-footer">
                        <button type="button" className="btn btn-warning fw-semibold" data-bs-dismiss="modal">CLOSE</button>
                    </div>
                </div>
            </div>
        </div>
