...
const Navbar = ({ searchCoins, setPage, setCurrency }) => {
  ...
  return (
    <nav className='navbar bg-warning bg-body-tertiary'>
      <div className='container-fluid px-3'>
        ...
        <form className='row d-flex' role='search'>
          ...
          <div className="col-auto d-flex align-items-center position-relative my-1 px-1">
            <select className="form-select" aria-label="Default select example" onChange={changePage}>
          ...
          <div className="search col d-flex align-items-center position-relative my-1 px-1">
            ...
            <input className='form-control ps-5 w-100' type='search' placeholder='Search' aria-label='Search'  
